        ...
        <CustomWrapper>
            <form className={Styles.form} onSubmit={submitHandler}>
                <div className={Styles.groups}>
                    ...
                    <input type='text' placeholder='' id='product_name' ref={product_name_ref}></input>
                   
                </div>
                <div className={Styles.groups}>
                    <label htmlFor='image'>Image</label>
                     <input type='text' placeholder='' id='image' ref={image_ref}></input>
                    
                </div>
                <div className={Styles.groups}>
                    <label htmlFor='price'>Price</label>
                    <input type='text' placeholder='' id='price' ref={price_ref}></input>
